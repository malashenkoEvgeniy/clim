            ...
            <div class="news-view">
                <div class="box box--gap">
                    <div class="news-view__head">
                        ...
                        @if($service->show_short_content)
                            <div class="news-view__teaser">{{ $service->current->short_content }}</div>
                        @endif
                    </div>
                </div>
                <div class="box box--gap">
                    <div class="news-view__body">
                        <div class="grid _flex-nowrap _mt-def">
                            ...
                            <div class="gcell gcell--auto _flex-grow">
                                @if($service->image && $service->image->exists)
                                    <div class="news-view__cover">
                                        {!! Widget::show('image', $service->image, 'big') !!}
                                    </div>
                                @endif
