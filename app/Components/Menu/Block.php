...
class Block
{
     ...
     * @param array $additionalRoutesForActiveDetect
     * @param string|null $icon
     * @return Link
     * @throws \App\Exceptions\WrongParametersException
     */
    final public function link(string $name, RouteObjectValue $route, array $additionalRoutesForActiveDetect = [], string $icon = null): Link
    {
