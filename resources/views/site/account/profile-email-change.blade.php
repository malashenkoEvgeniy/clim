                                                ...
                                                <div class="gcell gcell--12 _pt-sm _pb-lg _plr-lg">
                                                    <div class="grid _nmtb-lg">
                                                        ...
                                                        <div class="gcell gcell--12 _pt-sm _pb-lg">
                                                            <div class="control control--input">
                                                                <div class="control__inner">
                                                                    <input class="control__field" type="email" name="profile-new-email" id="profile-new-email">
                                                                    <label class="control__label" for="profile-new-email">Новая эл. почта</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
