...
$upload_dir = '/storage/app/public/files/filemanager/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../../storage/app/public/files/filemanager/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../../storage/app/public/files/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
$show_thumb_dir = '/storage/app/public/files/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
